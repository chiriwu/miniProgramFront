...
const history_data = require('./history.js')
const qiangguo_data = require('../question/2.js')
// console.log(datas.a)
Page({
  ...
  onUnload: function () {
    ...
    var curerror = this.data.errorsets


    var len = qiangguo_data.a.length
    
    curerror.forEach((value,index)=>{
      curerror[index] = len + value
    })
    curerror = Array.from(new Set(curerror.concat(errorseq)))
